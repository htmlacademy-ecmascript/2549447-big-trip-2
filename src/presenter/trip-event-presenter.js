...
export default class TripEventPresenter {
  ...
  constructor({ offersById, destination, offersByType, handlePointDataChange, onOpenEditForm, allTypesEvent, allNamesDestination, tripPointsModel, tripPointListComponent }) {
